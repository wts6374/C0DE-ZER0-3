...
public class SetBoxCollider : MonoBehaviour {
    ...
    //void BoxColliderLooper()
    //{
    //    looper.GetComponent<BoxCollider2D>().size = new Vector2(GetComponent<RectTransform>().rect.width, GetComponent<RectTransform>().rect.height - 1);
    //    looper.GetComponent<BoxCollider2D>().offset = new Vector2(1, -(GetComponent<RectTransform>().rect.height));
    //}
}
